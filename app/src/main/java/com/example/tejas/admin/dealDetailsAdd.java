...
//+ deal_validity_year);
    ...
    public void addToFirebase(View view) {
        SendToFirebase();
        ShowToast("Details have been added");
    ...
    private void SendToFirebase() {
        dealPromoCode = deal_promo_code.getText().toString().trim();

        DealStructure dealStructure = new DealStructure(
                imageName,
                imageUrl,
                deal_title.getText().toString(),
                deal_description.getText().toString(),
                longitude,latitude,
                deal_validity.getText().toString(),
                deal_validity_day,
                deal_validity_month,
                deal_validity_year,
                dealPromoCode);
